...
export function PrivacyPolicyContent({ onClose }: { onClose?: () => void }) {
    return (
        <div className="bg-[#f5f7f1] text-slate-800">
            <section className="relative overflow-hidden bg-emerald-950 px-4 pb-8 pt-4 text-white sm:px-6 sm:pb-10 sm:pt-5">
                ...
                <div className="relative mx-auto max-w-3xl">
                    ...
                    <div className="mt-5 max-w-2xl">
                        <p className="font-script text-2xl text-amber-300">Cuidamos lo que importa</p>
                        <h1 id="privacy-title" className="mt-1 font-serif text-3xl leading-tight sm:text-4xl">Política de Privacidad</h1>
            ...
            <section className="relative mx-auto -mt-4 max-w-3xl px-3 pb-4 sm:px-6 sm:pb-5">
                <article className="overflow-hidden rounded-2xl border border-emerald-900/10 bg-white shadow-[0_24px_60px_-30px_rgba(6,78,59,0.45)]">
                    <div className="border-b border-emerald-900/10 bg-[#fbfcf8] p-4 sm:p-6">
                        <div className="max-w-2xl">
                            ...
                            <div id="privacidad-contacto" className="mt-4 scroll-mt-4 border-t border-emerald-900/10 pt-4">
                                <div className="flex items-start gap-3">
                                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-amber-100 text-lg text-amber-700" aria-hidden="true">✦</span>
                                    <div>
                                        <h2 className="font-serif text-xl leading-tight text-emerald-950 sm:text-2xl">Información de contacto</h2>
                            ...
                            <div id="privacidad-uso-responsable" className="mt-4 scroll-mt-4 border-t border-emerald-900/10 pt-4">
                                <div className="flex items-start gap-3">
                                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-lg text-emerald-700" aria-hidden="true">✓</span>
                                    <div>
                                        <h2 className="font-serif text-xl leading-tight text-emerald-950 sm:text-2xl">Uso responsable</h2>
                                        <p className="mt-2 text-sm leading-6 text-slate-600 sm:text-base">
                            ...
                            <div className="mt-4 border-t border-emerald-900/10 pt-3 text-xs text-slate-500">
                                Última actualización: 2026
                            </div>
                        </div>
                    </div>

                    <div className="flex flex-wrap items-center justify-between gap-3 bg-emerald-950 px-4 py-4 text-white sm:px-6">
                        <div>
                        ...
                        <Link onClick={onClose} href="/#contacto" className="shrink-0 rounded-full bg-amber-400 px-5 py-2.5 text-sm font-semibold text-emerald-950 transition hover:bg-amber-300">
                            Ir a contacto
                        </Link>
                    </div>
                </article>
