...
export default function PrivacyPolicyPage() {
    return (
        <main className="min-h-screen bg-[#f5f7f1] text-slate-800">
            <section className="relative overflow-hidden bg-emerald-950 px-4 pb-20 pt-8 text-white sm:px-6 sm:pb-24 lg:px-8">
                ...
                <div className="relative mx-auto max-w-5xl">
                    ...
                    <div className="mt-16 max-w-2xl">
                        ...
                        <h1 className="mt-3 font-serif text-4xl leading-tight sm:text-6xl">Política de Privacidad</h1>
            ...
            <section className="relative mx-auto -mt-10 max-w-5xl px-4 pb-16 sm:px-6 lg:px-8">
                <article className="overflow-hidden rounded-[2rem] border border-emerald-900/10 bg-white shadow-[0_24px_60px_-30px_rgba(6,78,59,0.45)]">
                    <div className="grid gap-8 border-b border-emerald-900/10 bg-[#fbfcf8] p-6 sm:p-10 lg:grid-cols-[190px_1fr] lg:p-12">
                        <aside className="h-fit rounded-2xl bg-emerald-950 p-5 text-white">
                            ...
                            <nav className="mt-4 space-y-3 text-sm text-white/80">
                                <a className="block transition hover:text-amber-300" href="#introduccion">Introducción</a>
                                <a className="block transition hover:text-amber-300" href="#contacto">Información de contacto</a>
                                <a className="block transition hover:text-amber-300" href="#uso-responsable">Uso responsable</a>
                            </nav>
                        </aside>

                        <div className="max-w-2xl">
                            <div id="introduccion" className="scroll-mt-8">
                            ...
                            <div id="contacto" className="mt-10 scroll-mt-8 border-t border-emerald-900/10 pt-8">
                            ...
                            <div id="uso-responsable" className="mt-10 scroll-mt-8 border-t border-emerald-900/10 pt-8">
                                <div className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col items-start justify-between gap-4 bg-emerald-950 px-6 py-7 text-white sm:flex-row sm:items-center sm:px-10">
                        ...
                        <Link href="/#contacto" className="rounded-full bg-amber-400 px-5 py-2.5 text-sm font-semibold text-emerald-950 transition hover:bg-amber-300">
                            Ir a contacto
                        </Link>
                    </div>
                </article>
                ...
                <div className="mt-8 text-center">
                    <Link href="/" className="text-sm font-semibold text-emerald-800 transition hover:text-emerald-950">
